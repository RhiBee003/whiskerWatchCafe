...
Adjust times seasonally (Florida heat / daylight).
...
| Whisker Watch | Girlz and Gears |
|---|---|
| Patio + café host | Ride leadership & community |
| Food/drink / POS | Route, safety vibe, rider turnout |
| Optional lounge block | Promote to rider list / social |
| Collab merch shelf | Brand co-marketing |
| Insurance for premises | Rider waivers / ride liability as agreed |

Put the split in a simple **MOU** (not exclusive forever — start with 90-day pilot).

---

## Revenue ideas
- Wednesday patio specials / rider tabs  
- “Bike Night” session pack (lounge add-on discount for riders)  
- Collab stickers / tees (split margin)  
- Sponsor nights (local bike shop, women’s orgs)  
- Membership: “Gear + Whisker” monthly (1 lounge visit + bike-night perk)

**Investor angle:** turns a soft Wednesday into a recurring community night with built-in marketing.

---

## Soft launch plan
1. Soft-announce partnership (after LLC + site path clear)  
2. 4-week pilot Wednesdays  
3. Track: headcount, patio sales, lounge add-ons, new followers  
4. Decide: continue / expand / adjust route length  

---

## Sample social caption
> Wednesdays are for Girlz and Gears × Whisker Watch. Ride with us, hang on the patio, meet the adoptable cats inside (bikes stay outside). Girls Bike Night — every Wednesday.
...
*Planning draft. Finalize liability/waivers with counsel and both brands before public launch.*
